...
export const trails: HikingTrail[] = [
  ...
  {
    id: 7,
    title: "Dashbashi Canyon Trail",
    description:
      "This spectacular trail follows the rim of the Dashbashi Canyon before descending to the canyon floor. The path offers stunning views of multiple waterfalls cascading from the canyon walls. The lush vegetation and red rock formations create a dramatic contrast. The trail leads to a crystal-clear stream where you can cool off during summer months. The canyon's unique microclimate supports diverse plant life not found in surrounding areas.",
    region: "Kvemo Kartli",
    difficulty: {
      level: DifficultyLevel.Moderate,
      technicalDifficulty: 2,
    ...
    facilities: {
      waterAvailability: "Stream at canyon bottom (treatment necessary)",
      restroomAccess: false,
      parkingAvailable: true,
      publicTransportAccess: "Limited",
    },
    trailCondition: "Clear path but steep in sections",
    campingOptions: "No official camping",
    crowdLevel: {
      weekday: "Low",
      weekend: "Moderate",
      peakSeason: "High near the glass bridge attraction",
    },
    familyFriendly: false,
    dogFriendly: true,
    wheelchairAccessible: "No",
    hikingPoles: "Recommended for descent and ascent",
    highlights: [
      "Multiple waterfalls",
      "Canyon views",
    ...
    hazards: ["Steep drops", "Slippery rocks near water"],
    nearbyAttractions: ["Tsalka Reservoir", "Glass Bridge viewpoint"],
    startingPoint: {
      name: "Dashbashi Canyon Parking",
      coordinates: {
        latitude: 41.6003,
        longitude: 44.0919,
      },
      googleMapsUrl: "https://goo.gl/maps/dashbashiparking",
    },
    endPoint: "Same as starting point (out and back trail)",
    cellPhoneReception: "Good at rim, limited in canyon",
    imageUrl: "https://example.com/images/dashbashi.jpg",
    tags: ["Canyon", "Waterfalls", "Swimming", "Day hike", "Scenic views"],
  },
  {
    id: 8,
